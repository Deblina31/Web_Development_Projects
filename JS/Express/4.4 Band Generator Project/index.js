...
app.post("/submit", (req, res) => {
  ...
  var randomPos=Math.floor(Math.random()*adj.length);
  var randomAdj=adj[randomPos];
  var randomNoun=noun[randomPos];
  var randomName= randomAdj+" "+randomNoun;

  res.render("index.ejs", {randomName: randomName, year:year});
});
